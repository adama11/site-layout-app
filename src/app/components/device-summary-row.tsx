...
export const DeviceSummaryRow = ({
  ...
  return (
    <div className="flex justify-between gap-4 border border-slate-400 rounded-md p-2">
      ...
      {deviceName !== "Transformer" ? (
        ...
        <div className="flex gap-2 items-center justify-center w-[128px]">
          <div className="text-lg font-bold">{deviceCount}</div>
        </div>
      )}
    </div>
  );
