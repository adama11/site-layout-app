  ...
  useEffect(() => {
    if (canvasRef.current !== null) {
      ...
      if (ctx !== null) {
        ...
        ctx.clearRect(0, 0, canvasRef.current.width * CANVAS_SCALE, canvasRef.current.height * CANVAS_SCALE);
        ctx.fillStyle = '#e1e4ed';
        ctx.rect(0, 0, canvasRef.current.width * CANVAS_SCALE, canvasRef.current.height * CANVAS_SCALE);
        ctx.fill();
